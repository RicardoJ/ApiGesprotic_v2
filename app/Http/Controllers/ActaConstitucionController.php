...
class ActaConstitucionController extends Controller
{
    ...
    public function store(Request $request,$project_id)
    {
        ...
        $validator = Validator::make($request->all(),[
            ...
            'cliente_peticionario_nombre' =>'required',
            'cliente_representante_legal_departamento'=>'required', 
            'cliente_representante_legal_nombre'=>'required',
            'documentacion_adjunta_enunciado_trabajo'=>'required', 
            'documentacion_adjunta_caso_negocio'=>'required',
            'documentacion_adjunta_contrato'=>'required',
            ...
            'nivel_superior_decision_persona'=>'required', 
            'nivel_superior_decision_departamento'=>'required', 
            'firma'=>'required',
        ...
        'cliente_peticionario_nombre' =>$request->input('cliente_peticionario_nombre'),
        'cliente_representante_legal_departamento'=>$request->input('cliente_representante_legal_departamento'),
        'cliente_representante_legal_nombre'=>$request->input('cliente_representante_legal_nombre'),
        'documentacion_adjunta_enunciado_trabajo'=>$request->input('documentacion_adjunta_enunciado_trabajo'),
        'documentacion_adjunta_caso_negocio'=>$request->input('documentacion_adjunta_caso_negocio'),
        'documentacion_adjunta_contrato'=>$request->input('documentacion_adjunta_contrato'),
        ...
        'volumen_de_contratacion'=>$request->input('volumen_de_contratacion'),
        'nivel_superior_decision_persona'=>$request->input('nivel_superior_decision_persona'),
        'nivel_superior_decision_departamento'=>$request->input('nivel_superior_decision_departamento'),
...
$save = array();
 foreach ($fases as $value) {
    ...
    $dataFase = [
        ...
        'nombre_de_fase'=>$value['nombre_de_fase'],
